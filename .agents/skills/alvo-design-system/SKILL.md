---
name: alvo-design-system
description: >
  Alvo's official design system. Use when creating, editing, or reviewing any Vue component,
  CSS, or UI layout in this project. Enforces the Pearl & Sapphire color palette, Geist typography,
  glassmorphism card pattern, dark mode strategy, motion guidelines, and component specifications.
---
